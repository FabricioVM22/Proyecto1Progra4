...
insert into cliente(cedula,nombre,tipo_cedula,email)values(18620,'Carlos','DIMEX','carlitos@gmail.com');
insert into producto(num_producto,descripcion,cantidad)values(15,'Natilla',50);
